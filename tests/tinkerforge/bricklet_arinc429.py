...
class BrickletARINC429(Device):
    ...
    def get_channel_configuration(self, channel):
        ...
        as the :func:`set_channel_configuration`,  despite that the all-channels constants CHANNEL_TX and CHANNEL_RX can not be used.
        """
        self.check_validity()
    ...
    def get_channel_mode(self, channel):
        ...
        :func:`set_channel_configuration`, despite that the all-channels constants CHANNEL_TX and CHANNEL_RX can not be used.
        """
        self.check_validity()
    ...
    def set_schedule_entry(self, channel, job_index, job, frame_index, dwell_time):
        ...
        The :func:`set_schedule_entry` can be called while the TX scheduler is running, i.e. the channel mode is set to 'RUN'.
    ...
    def get_schedule_entry(self, channel, job_index):
        """
        Gets the definition of a transmit scheduler job table entry, refer to the :func:`set_schedule_entry`.
        """
        self.check_validity()
