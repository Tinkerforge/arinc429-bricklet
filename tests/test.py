...
if __name__ == "__main__":
    ...
    # 1 MASTER RESET
    error = a429.debug_write_register(0x04, [])
    ...
    error = a429.debug_write_register(0x38, [0x00])
    if error != BrickletARINC429.RW_ERROR_OK:
        print('2 !!! Error during ACLK write: {0}'.format(error))
    else:
        print('2 ACLK write OK')

    ret = a429.debug_read_register(0xD4)
    ...
    ret = a429.debug_read_register(0x90)
    if ret.rw_error != BrickletARINC429.RW_ERROR_OK:
    ...
    ret = a429.debug_read_register(0xB0)
    if ret.rw_error != BrickletARINC429.RW_ERROR_OK:
    ...
    # 16 WRITE TO TX FIFO
    error = a429.debug_write_register(0x0C, [0x01, 0x02, 0x03, 0x04])
    if error != BrickletARINC429.RW_ERROR_OK:
    ...
    ret = a429.debug_read_register(0xA0)
    if ret.rw_error != BrickletARINC429.RW_ERROR_OK:
    ...
    ret = a429.debug_read_register(0xC0)
    if ret.rw_error != BrickletARINC429.RW_ERROR_OK:
    ...
    error = a429.debug_write_register(0x08, [0x44])
    if error != BrickletARINC429.RW_ERROR_OK:
    ...
    error = a429.debug_write_register(0x40, [])
    if error != BrickletARINC429.RW_ERROR_OK:
